...
tap_dance_action_t tap_dance_actions[] = {
    [TD_BSPC_ARROWS] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_BSPC, ARROWS),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ansi_107(
        ...
        KC_F20,       KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,    KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        KC_F21,       KC_LCTL,  KC_LGUI,           KC_LALT, KC_SPC,  MO(EXTRA),           KC_BSPC,    KC_ENT,           TD(TD_BSPC_ARROWS),            KC_LEFT,  KC_DOWN,  KC_RGHT, KC_P0,   KC_PDOT        ),
    ...
    [ARROWS] = LAYOUT_ansi_107(
        _______,    _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,            _______, _______, _______, _______,
        _______,    _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,            _______, _______, _______, _______,
        _______,    _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,            _______, _______, _______, _______,
        _______,    _______,  _______,  _______,  _______,  _______,  _______,   KC_LEFT,  KC_DOWN,  KC_UP,   KC_RIGHT,  _______,  _______,             _______,            _______, _______, _______,
        _______,    _______,            _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______, _______, _______, _______,
        _______,    _______,  _______,            _______,  _______,  _______,             _______,            _______,            _______,             _______,  _______,  _______, _______, _______        ),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [ARROWS] = {ENCODER_CCW_CW(KC_NO, KC_NO)},
};
